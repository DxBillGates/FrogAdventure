...
Dx12_CBVSRVUAVHeap::Dx12_CBVSRVUAVHeap(ID3D12Device * device, int cbvNum, int srvNum, int uavNum)
{
	pDevice = device;
...
void Dx12_CBVSRVUAVHeap::Set(ID3D12GraphicsCommandList * cmdList)
{
